...
import { Upload, FileText, Edit3, Eye, ArrowLeft, Briefcase, MapPin, DollarSign, Clock, Star, CheckCircle, AlertCircle } from "lucide-react";
          ...
          {entryMode === "manual" && (
            <form onSubmit={handleSubmit} className="p-8">
              <div className="space-y-6">
                ...
                {/* Preview Section */}
                {(form.role || form.location || form.pay) && (
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                  <Button
                    ...
                    disabled={loading || !form.jdFile}
                    className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 rounded-xl font-medium hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <div className="flex items-center justify-center">
                        <div className="animate-spin rounded-full h-5 w-5 border-2 border-white border-t-transparent mr-2"></div>
