...
const ViewAllUploads = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        // Fetch employer profile and profile image
        ...
        // Fetch job summaries from subcollection
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {uploads.map((job) => (
        ...
        >
          ...
          <div className="flex items-center space-x-2">
            <div className={`px-3 py-1 rounded-full text-sm font-semibold ${getPriorityBadgeClasses(job.priority)}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4">
                    ...
                    <div className="mt-2">
                      <span className={`px-3 py-1 rounded-full text-sm font-semibold ${getPriorityBadgeClasses(selectedJob.priority)}`}>
  ...
  const renderProfileModal = () => {
    if (!showProfile || !employerProfile) return null;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
        <Card className="bg-white/70 backdrop-blur-sm border border-white/20 shadow-xl">
          ...
          <CardContent className="p-8">
            {uploads.length === 0 ? renderEmptyState() : renderJobGrid()}
          </CardContent>
        </Card>
      </div>
